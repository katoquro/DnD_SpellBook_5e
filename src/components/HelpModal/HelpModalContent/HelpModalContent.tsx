...
export default component({
  render(h): VNode {
    return <HelpModalContentStyled>
      ...
      <p>
        Карточку заклинаний можно скрыть из общего списка, если нажать на <FaIcon icon={faEyeSlash} /> в правом верхнем углу карточки.
      ...
      <ul>
        ...
        <li>Закреплять/Откреплять карточки. При клике на иконке замка <FaIcon icon={faLock} /> на любой из карточек
          будут закреплены все выделенные.
          Аналогично при откреплении закрепленных карточек.
        </li>
        <li>Прятать карточки. При клике на иконке глаза <FaIcon icon={faLock} /> на любой из карточек будут скрыты
          все выделенные.
        </li>
      </ul>

...
export default component({
  render (h):VNode {
    return <InfoTextStyled>
          ...
          <p>
              Карточку заклинаний можно скрыть из общего списка, если нажать на <i class="fa fa-eye-slash"
              aria-hidden="true" /> в правом верхнем углу карточки. В таком случае заклинание исчезнет из
              общего списка и его название будет отображаться в самом низу панели фильтров. Если нажать на
              название, заклинание вернется в общий список.
          </p>
          <h2>
          ...
          <p>
              ...
              заклинаний. Для закрепления нужно нажать на <i class="fa fa-lock" aria-hidden="true" /> в левом
          ...
          <ul>
              ...
              <li>Закреплять/Откреплять карточки. При клике на иконке замка <i class="fa fa-lock" aria-hidden="true"
                    /> на любой из карточек будут закреплены все выделенные.
                  Аналогично при откреплении закрепленных карточек.
              </li>
              <li>Прятать карточки. При клике на иконке глаза <i class="fa fa-eye-slash" aria-hidden="true"
